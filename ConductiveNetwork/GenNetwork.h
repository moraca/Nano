...
private:
    ...
    int Discretize_plane(const struct cuboid &gvcub, const MathMatrix rotation, const Point_3D center, const Point_3D &corner, const Point_3D &step_x1, const Point_3D &step_x2, const int &n_points_x1, const int &n_points_x2, const int &side_flag, vector<Point_3D> &gnp_discrete)const;
